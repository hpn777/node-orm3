  ...
  async getColumns(tableName: string): Promise<PgColumn[]> {
    ...
    const sql = `WITH column_privileges AS (
      ...
      FROM information_schema.columns c
        LEFT JOIN table_column_constraints tcc
          ON c.table_schema = tcc.table_schema
         AND c.table_name = tcc.table_name
         AND c.column_name = tcc.column_name
        ...
        LEFT JOIN information_schema.referential_constraints rc
          ON tcc.constraint_schema = rc.constraint_schema
         AND tcc.constraint_name = rc.constraint_name
        LEFT JOIN information_schema.constraint_column_usage ccu
          ON tcc.constraint_schema = ccu.constraint_schema
         AND tcc.constraint_name = ccu.constraint_name
