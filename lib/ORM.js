...
exports.connect = function (opts, cb) {
  ...
  if (Object.prototype.hasOwnProperty.call(opts, "hostname")) {
...
ORM.prototype.define = function (name, properties, opts) {
  ...
  this.models[name] = new Model({
    ...
    identityCache       : Object.prototype.hasOwnProperty.call(opts, "identityCache") ? opts.identityCache : this.settings.get("instance.identityCache"),
    keys           : opts.id,
